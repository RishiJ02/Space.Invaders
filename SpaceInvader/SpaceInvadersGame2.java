...
public class SpaceInvadersGame2 extends Application implements EventHandler<InputEvent>{
	GraphicsContext gc;
	Image ship1;
	Image ship1Extra;
	Image ship2;
	...
	public void handle(final InputEvent event){
		if (event instanceof KeyEvent){
			...
			if (((KeyEvent)event).getCode() == KeyCode.SPACE){
				...
				playerBullets.add(new Bullet(3,playerX+60,playerY));
			...
			public void handle(long now) {
				...
				*/
				...
				if(HP>0){
					...
					gc.fillText( "Seconds Till Rebuild: "+(double)secondsPassed/1000.0, 500, 500 );
					gc.strokeText( "Seconds Till Rebuild: "+(double)secondsPassed/1000.0, 500, 500 );
